  ...
  try {
    ...
    await prisma.learningProfile.upsert({
      ...
      create: {
        ...
        topicMastery: JSON.parse(JSON.stringify(analysis.topicMastery)),
    ...
    await prisma.learningPlan.create({
      data: {
        ...
        aiOutput: JSON.parse(JSON.stringify(plan)),
        status: "active",
      },
    });
    ...
    await prisma.progressRecord.create({
      data: {
        ...
        subjectId: assessment.subjectId,
        overallMastery: assessment.overallScore,
        topicScores: JSON.parse(JSON.stringify(topicScores.map(ts => ({ topicName: ts.topicName, score: ts.percentage })))),
        trigger: "assessment",
