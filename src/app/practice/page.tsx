          ...
          <div className="bg-white rounded-2xl border border-slate-200/90 shadow-sm p-6 sm:p-8 space-y-6">
              ...
              {currentQ.options.map((opt, optIdx) => {
                ...
                return (
                  <button
                    ...
                    className={`w-full flex items-start gap-3.5 p-3.5 rounded-xl border text-left text-xs sm:text-sm transition-all ${
                      checked
            ...
            <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
              <button
                ...
                className="px-4 py-2 rounded-xl border border-slate-200 text-slate-600 hover:bg-slate-50 text-xs font-semibold disabled:opacity-30 disabled:pointer-events-none transition-colors"
              >
                Previous
              </button>
              ...
              {currentIndex === questions.length - 1 ? (
                <button
                  ...
                  className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold transition-all shadow-md shadow-indigo-100 disabled:opacity-50"
                >
                  {submitting ? (
                    <>
                ...
                <button
                  ...
                  className="flex items-center gap-1.5 px-5 py-2.5 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white text-xs font-semibold transition-all shadow-sm"
                >
